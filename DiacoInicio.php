...
<body>
	...
	<div class="card crdbody">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="card crdbody"><!--aqui inicia el card-->
					<div class="card-header"><h4>Quienes Somos</h4></div>
							<div class="card-body">
							<!-- FORMULARIO DE PRUEBAS   --->

							<p>La DIACO (Dirección de Atención y Asistencia al Consumidor) es una entidad del gobierno de Guatemala que se encarga de proteger los derechos de los consumidores y usuarios en el país. Fue creada en 1997 
								mediante la Ley de Protección al Consumidor y Usuario, y desde entonces ha sido responsable de velar por el cumplimiento de esta ley y 
								de resolver conflictos entre consumidores y proveedores de bienes y servicios.</p>
							<p>La DIACO tiene como objetivo garantizar que los consumidores y usuarios reciban bienes y servicios de calidad, así como también promover prácticas comerciales justas
							y transparentes. Para cumplir con su misión, la DIACO tiene la facultad de realizar inspecciones, recibir denuncias y reclamos, brindar asesoría legal y representación en procesos 
					...
					<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active" data-bs-interval="10000">
								<img src="/assets/images/DIACO-1000x600.jpg" class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">

								</div>
							</div>
							<div class="carousel-item" data-bs-interval="2000">
								<img src="/assets/images/Verificaciones-Diaco-2.jpg" class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">

								</div>
							</div>
							<div class="carousel-item">
								<img src="/assets/images/verificaciones-diaco-scaled.jpg" class="d-block w-100" alt="...">
								<div class="carousel-caption d-none d-md-block">
