...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family: 'Shantell Sans', cursive;&family=Amatic+SC:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&family=Inter:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet">
					...
					<div class="card-header"><h4>Detalle de Queja</h4></div>
							...
							<div class="row crdbody">
									<div class="form-group col-sm-3"><div class="input-group">
										...
										<select name='Departameto' id="Mon" class="form-select">
                                        <?php 
					...
					<div class="card crdbody">
						<section id="contact" class="contact">
							<div class="container" data-aos="fade-up">
							  ...
							  <div class="mb-3">
								<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15381.120684222107!2d-90.379049!3d15.4693548!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x37dae4c7041d1fb6!2sSweet%20Wrap!5e0!3m2!1ses-419!2sgt!4v1677386333493!5m2!1ses-419!2sgt" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
							  </div><!-- End Google Maps -->
								...
								<div class="col-md-6">
								  <div class="info-item  d-flex align-items-center">
									...
									<div>
									  ...
									  <p> 8av 3-12 Zona 2 Coban Alta Verapza </p>
									</div>
								  </div>
								</div><!-- End Info Item -->
								...
								<div class="col-md-6">
								  <div class="info-item  d-flex align-items-center">
									...
									<div>
									  ...
									  <div><strong>Lunes-Domingo:</strong> 10AM - 7:30PM;
							  ...
							  <form action="forms/contact.php" method="post" role="form" class="php-email-form p-3 p-md-4">
								...
								<div class="row crdbody"><div class="form-group">
